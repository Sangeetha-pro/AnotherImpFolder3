...
def configure_retriever(pdf_loader):
    ...
    # This line creates a FAISS vector store (an index) from the documents loaded by pdf_loader.
    #  It uses the embeddings to convert the documents into vectors and stores them in the FAISS index.
